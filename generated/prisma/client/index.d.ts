...
export namespace Prisma {
  ...
  */
  ...
  export type VaultEntryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "numericId" | "title" | "slug" | "content" | "category" | "authorId" | "published" | "createdAt" | "updatedAt", ExtArgs["result"]["vaultEntry"]>
  ...
  interface VaultEntryFieldRefs {
    ...
    readonly category: FieldRef<"VaultEntry", 'String'>
  ...
  export type VaultEntryWhereInput = {
    ...
    category?: StringFilter<"VaultEntry"> | string
  ...
  export type VaultEntryScalarWhereWithAggregatesInput = {
    ...
    category?: StringWithAggregatesFilter<"VaultEntry"> | string
